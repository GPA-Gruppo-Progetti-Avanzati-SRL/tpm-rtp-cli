...
const (
	...
	ExternalPaymentCancellationRejection1CodeSample    = "oJ"
...
const (
	...
	ExternalServiceLevel1CodeSample    = "nN"
...
const (
	...
	IBAN2007IdentifierSample = "GI84w"
)
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "PGsiuzytMOJPatwtPi"
...
const (
	...
	ExternalCashAccountType1CodeSample    = "lf"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "sf"
...
const (
	...
	ExternalPaymentGroupStatus1CodeSample    = "yk"
...
const (
	...
	ExternalClaimNonReceiptRejection1CodeSample    = "Gp"
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "lhxtxVSGpqaJaBRgAvzLXqzRrrUIYvaIujDpHYjxeUBrVfdwUzWHRihFDPRHBMuEWmaNvhHLITWJcJKzJsRPeJbpTqWPUlWAcidRlufmYWddEktBDrWMYZTPdmDAVCuvQutLDKFBGRxnyDNYuRKWsmZnOYgSLPSsuMMmvYmaFEjLgSv"
	Max350TextLength    = 0
...
const (
	...
	ExternalStatusReason1CodeSample    = "nd"
...
const (
	...
	ExternalPaymentCompensationReason1CodeSample    = "Te"
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "ra"
...
const (
	...
	Exact4AlphaNumericTextSample = "icPs"
)
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "nxGMNCcCdlEBYqxqrgAieJuFVZUsgPmweLRmsdTIwtLUDqoBSNtPRViLXLCrSAZC"
	Max128TextLength    = 0
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "jx"
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "TC"
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "aZ"
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "nfHRhEbbvlLkCbvOl"
	Max34TextLength    = 0
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "Rr"
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "OW"
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "IRO"
)
...
const (
	...
	UUIDv4IdentifierSample = "2e9028d7-b5a9-4c51-854b-25e28ec983b3"
)
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "NwNQBqyozKVGeninyrTgqubNiIzWcEZsdyUJTDAODnRKcTqZThaTJ"
	Max105TextLength    = 0
...
const (
	...
	ExternalDocumentType1CodeSample    = "lO"
...
const (
	...
	BICFIDec2014IdentifierSample = "788URIM9"
)
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "EaCEmEUmEtNTDVBbvMBtQBeDBVyDFfPWGaZ"
	Max70TextLength    = 0
...
const (
	...
	ExternalPaymentModificationRejection1CodeSample    = "Qn"
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "tP"
...
const (
	...
	ExternalDocumentFormat1CodeSample    = "iy"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	AnyBICDec2014IdentifierSample = "RDQCLUPPX5J"
)
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "uF"
...
const (
	...
	ExternalCancellationReason1CodeSample    = "OP"
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "ctLBlMZxcxWxtuKOMWJPKLdPagMDpbVTfGYQeuDWBbAsCNeGzZKpmgINTkianyMbMixyxc"
	Max140TextLength    = 0
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "KWDR5KBBWFVAOYV85M18"
)
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "PQ"
...
const (
	...
	ExternalPaymentTransactionStatus1CodeSample    = "jM"
...
const (
	...
	ExternalMandateSetupReason1CodeSample    = "CS"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "HCDrkbuyVTPEZjtFPu"
	Max35TextLength    = 0
...
const (
	...
	ExternalChargeType1CodeSample    = "vT"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "ZsH"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "Zz"
...
const (
	...
	ExternalInvestigationExecutionConfirmation1CodeSample    = "za"
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
