...
const (
	...
	ExternalCashAccountType1CodeSample    = "nN"
...
const (
	...
	ExternalPaymentCancellationRejection1CodeSample    = "iu"
...
const (
	...
	ExternalDocumentFormat1CodeSample    = "zy"
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "tP"
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "ilfsfykSBGplhxtxVS"
...
const (
	PhoneNumberZero   = ""
	PhoneNumberSample = "+75-353)44)3+7"
)
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "Gp"
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "qaJaBRgAvzLXqzRrrUIYvaIujDpHYjxeUBrVfdwUzWHRihFDPRHBMuEWmaNvhHLITWJcJKzJsRPeJbpTqWPUlWAcidRlufmYWddEktBDrWMYZTPdmDAVCuvQutLDKFBGRxnyDNYuRKWsmZnOYgSLPSsuMMmvYmaFEjLgSvndTeranxG"
	Max350TextLength    = 0
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	ExternalPaymentCompensationReason1CodeSample    = "Fc"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "Qt"
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "Xo"
...
const (
	...
	ExternalMandateSetupReason1CodeSample    = "vQ"
...
const (
	...
	Max15NumericTextSample = "296933803"
)
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "bjAyWbspgheqXXumwlaMkvqgeVNsLyylTpEsGuymNstQzxPbmXGYPZRoCcAjYwji"
	Max128TextLength    = 0
...
const (
	...
	ExternalCancellationReason1CodeSample    = "cE"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "LciiQYDuPezahlBGYs"
	Max35TextLength    = 0
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "JCVIS9SOL58AYYCHGU07"
)
...
const (
	...
	Exact4AlphaNumericTextSample = "JTQ0"
)
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "XsQyazOWcrSbAuTep"
	Max34TextLength    = 0
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "BSUGepQDYBzMBKXUbWscOLULiIiQtPiPomlXcvuojfHBHOQiGrmoSuelNipGLXawNpUCRN"
	Max140TextLength    = 0
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "oV"
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "MT"
...
const (
	...
	ExternalServiceLevel1CodeSample    = "KO"
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "Gg"
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "xNQPpRiWmNuFOPctLBlMZxcxWxtuKOMWJPKLdPagMDpbVTfGYQeuD"
	Max105TextLength    = 0
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "XUG"
)
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "WB"
...
const (
	...
	ExternalPaymentTransactionStatus1CodeSample    = "bA"
...
const (
	...
	BICFIDec2014IdentifierSample = "XPYSQS9B"
)
...
const (
	...
	IBAN2007IdentifierSample = "GR14WHAc"
)
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "sC"
...
const (
	...
	AnyBICDec2014IdentifierSample = "30SVYBUW"
)
...
const (
	...
	ExternalStatusReason1CodeSample    = "Gz"
...
const (
	...
	UUIDv4IdentifierSample = "26fc63f9-0807-4990-bf8b-27fd12ebd2b0"
)
...
const (
	...
	ExternalPaymentGroupStatus1CodeSample    = "ZK"
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "pmgINTkianyMbMixyxcPQjMCSHCDrkbuyVT"
	Max70TextLength    = 0
...
const (
	...
	ExternalPaymentModificationRejection1CodeSample    = "PE"
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "Zj"
...
const (
	...
	ExternalInvestigationExecutionConfirmation1CodeSample    = "TZ"
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	ExternalChargeType1CodeSample    = "Kw"
...
const (
	...
	ExternalDocumentType1CodeSample    = "pG"
