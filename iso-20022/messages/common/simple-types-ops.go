...
const (
	...
	BICFIDec2014IdentifierSample = "FLOLHFU0"
)
...
const (
	...
	AnyBICDec2014IdentifierSample = "2ZP8DTPKQYV"
)
...
const (
	...
	ExternalServiceLevel1CodeSample    = "Gs"
...
const (
	...
	ExternalCancellationReason1CodeSample    = "zy"
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "at"
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "PJ7NVKU70LOPG98UM503"
)
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "UXR"
)
...
const (
	...
	ExternalDocumentFormat1CodeSample    = "wt"
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "PilfsfykSBGplhxtxVSGpqaJaBRgAvzLXqzRrrUIYvaIujDpHYjxeUBrVfdwUzWHRihFDP"
	Max140TextLength    = 0
...
const (
	...
	ExternalMandateSetupReason1CodeSample    = "RH"
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "BM"
...
const (
	...
	ExternalPaymentModificationRejection1CodeSample    = "uE"
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "WmaNvhHLITWJcJKzJsRPeJbpTqWPUlWAcidRlufmYWddEktBDrWMYZTPdmDAVCuvQutLDKFBGRxnyDNYuRKWsmZnOYgSLPSsuMMmvYmaFEjLgSvndTeranxGMNCcCdlEBYqxqrgAieJuFVZUsgPmweLRmsdTIwtLUDqoBSNtPRViLXL"
	Max350TextLength    = 0
...
const (
	...
	ExternalPaymentGroupStatus1CodeSample    = "Cr"
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "SA"
...
const (
	...
	ExternalChargeType1CodeSample    = "ZC"
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "jxTCaZnfHRhEbbvlL"
	Max34TextLength    = 0
...
const (
	...
	ExternalStatusReason1CodeSample    = "bv"
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "OlRrOWJFNwNQBqyozK"
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "VGeninyrTgqubNiIzWcEZsdyUJTDAODnRKcTqZThaTJmRVAClOEaC"
	Max105TextLength    = 0
...
const (
	...
	ExternalPaymentTransactionStatus1CodeSample    = "Em"
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "EUmEtNTDVBbvMBtQBeDBVyDFfPWGaZQntPi"
	Max70TextLength    = 0
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "yJ"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "RiWmNuFOPctLBlMZxcxWxtuKOMWJPKLdPagMDpbVTfGYQeuDWBbAsCNeGzZKpmgI"
	Max128TextLength    = 0
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "NT"
...
const (
	...
	ExternalPaymentCompensationReason1CodeSample    = "ki"
...
const (
	...
	IBAN2007IdentifierSample = "LJ36KNOfm"
)
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "an"
...
const (
	...
	ExternalClaimNonReceiptRejection1CodeSample    = "yM"
...
const (
	...
	UUIDv4IdentifierSample = "092ca3e8-e2bb-49ac-8e4e-d3ec45135b37"
)
...
const (
	...
	ExternalInvestigationExecutionConfirmation1CodeSample    = "bM"
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "Ga"
...
const (
	...
	Max15NumericTextSample = "4168322"
)
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "ma"
...
const (
	...
	Exact4AlphaNumericTextSample = "9QFe"
)
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "cy"
...
const (
	...
	ExternalPaymentCancellationRejection1CodeSample    = "vH"
