...
const (
	...
	ExternalMandateSetupReason1CodeSample    = "oJ"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "nNP"
...
const (
	...
	UUIDv4IdentifierSample = "f3bccbd2-2d6f-44ea-ad2e-01616d27feb7"
)
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "GsiuzytMOJPatwtPilfsfykSBGplhxtxVSGpqaJaBRgAvzLXqzRrrUIYvaIujDpHYjxeUB"
	Max140TextLength    = 0
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "rV"
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "fd"
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "8YNB41CR2R6AU6822P46"
)
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "wU"
...
const (
	...
	ExternalDocumentFormat1CodeSample    = "zW"
...
const (
	...
	ExternalPaymentTransactionStatus1CodeSample    = "HR"
...
const (
	...
	ExternalInvestigationExecutionConfirmation1CodeSample    = "ih"
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "FDPRHBMuEWmaNvhHLITWJcJKzJsRPeJbpTqWPUlWAcidRlufmYWdd"
	Max105TextLength    = 0
...
const (
	...
	ExternalStatusReason1CodeSample    = "YZ"
...
const (
	...
	ExternalPaymentCompensationReason1CodeSample    = "dm"
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "DAVCuvQutLDKFBGRxnyDNYuRKWsmZnOYgSLPSsuMMmvYmaFEjLgSvndTeranxGMN"
	Max128TextLength    = 0
...
const (
	...
	ExternalServiceLevel1CodeSample    = "Cc"
...
const (
	...
	Exact4AlphaNumericTextSample = "dbO1"
)
...
const (
	...
	ExternalClaimNonReceiptRejection1CodeSample    = "Cd"
...
const (
	...
	AnyBICDec2014IdentifierSample = "JT2ORNFR"
)
...
const (
	...
	IBAN2007IdentifierSample = "MP44htzFdr"
)
...
const (
	...
	ExternalPaymentCancellationRejection1CodeSample    = "lE"
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "BY"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "qx"
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	ExternalChargeType1CodeSample    = "yd"
...
const (
	...
	ExternalDocumentType1CodeSample    = "nI"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "NY"
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "cz"
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "GVyZhBRwWAXjuufUoPJlNOFUvANpjrlwiuIbjJbgkIxMkImqLfMdmksNxvjgyEJAjrjcQDUlVTuFKDLjgBjrpEBlRzIZVSUAgxlZPBVcodWJbYmpBEprbxsRnSFqRIjOBrNaxVzTtXlnbdWOKzddfZvtzFRwXkWBBNMmMfCraUahSxp"
	Max350TextLength    = 0
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "TkppSxjPLhPnxeSCju"
	Max35TextLength    = 0
...
const (
	...
	ExternalCashAccountType1CodeSample    = "ln"
...
const (
	...
	ExternalPaymentModificationRejection1CodeSample    = "ke"
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "SRvUtXaQHrOqxrwbC"
	Max34TextLength    = 0
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "XR"
...
const (
	...
	BICFIDec2014IdentifierSample = "6K6JFM6W"
)
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "iWGXOyolORPasKWOdANVLTUjsQCqRuNsAzg"
	Max70TextLength    = 0
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "ax"
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "RIN"
)
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "obcyvHxKEqjfuCczVQ"
...
const (
	...
	ExternalCancellationReason1CodeSample    = "ir"
...
const (
	...
	Max15NumericTextSample = "7157396761"
)
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "HY"
...
const (
	...
	ExternalPaymentGroupStatus1CodeSample    = "Kw"
