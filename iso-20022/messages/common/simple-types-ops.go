...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "wtP"
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "il"
...
const (
	...
	ExternalCancellationReason1CodeSample    = "fs"
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "fy"
...
const (
	...
	ExternalClaimNonReceiptRejection1CodeSample    = "kS"
...
const (
	...
	ExternalPaymentTransactionStatus1CodeSample    = "BG"
...
const (
	...
	ExternalPaymentCompensationReason1CodeSample    = "xV"
...
const (
	...
	IBAN2007IdentifierSample = "CP818D"
)
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "aq"
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "JjgVXQtZptcLZIVmypNpLbbaxHYDmKrYnEb"
	Max70TextLength    = 0
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "YQZ"
)
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "qb"
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "vW"
...
const (
	...
	ExternalPaymentGroupStatus1CodeSample    = "Lj"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "ZZ"
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "AH"
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "QPLGFB0HXH4EM21US923"
)
...
const (
	...
	Exact4AlphaNumericTextSample = "vZzi"
)
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "WIGRYPwqfeXSWmRncQZpTAzceEsIpdYbrhfkVRdPhRXJzEKTBNCvo"
	Max105TextLength    = 0
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "khNhSeFRvuKeklvsHwabufMjYxuvCIeoMjxivfYHKXcwedxkRvEookKzpacqgBiXejXjTJ"
	Max140TextLength    = 0
...
const (
	...
	BICFIDec2014IdentifierSample = "YK87SW84BTK"
)
...
const (
	...
	ExternalInvestigationExecutionConfirmation1CodeSample    = "Ph"
...
const (
	...
	ExternalDocumentFormat1CodeSample    = "MQ"
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "smGzinFnyUVhVOydn"
	Max34TextLength    = 0
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "IN"
...
const (
	...
	ExternalCashAccountType1CodeSample    = "Yc"
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "zG"
...
const (
	...
	AnyBICDec2014IdentifierSample = "0HD4FQY2"
)
...
const (
	...
	ExternalChargeType1CodeSample    = "Vy"
...
const (
	...
	UUIDv4IdentifierSample = "4aceb781-e262-4fe7-b9bc-2d25fec21514"
)
...
const (
	...
	ExternalPaymentModificationRejection1CodeSample    = "Zh"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	ExternalServiceLevel1CodeSample    = "Fu"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "gFaMgpvghTAmlfdkeD"
	Max35TextLength    = 0
...
const (
	...
	Max15NumericTextSample = "77224587"
)
...
const (
	...
	ExternalMandateSetupReason1CodeSample    = "GE"
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "mMnhtVqIWhsYkMmmIJSJYWUaOHkakUxhxmqKjctRaQKgzbGvArTdZoNzcwgvmZkR"
	Max128TextLength    = 0
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "AO"
...
const (
	...
	ExternalDocumentType1CodeSample    = "UB"
...
const (
	...
	ExternalStatusReason1CodeSample    = "uS"
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "QfgjgNtyljntNWeqXXYMdxTRsqOTDdeltIIBZgZYJCjhEHHskeVLOdmPbocRvjeIFqcbbyaToaaLLczPeHYSnzubklHSaxZVdHppAFbHZnhPpTOSyMuzRWOXcuCUExoZFaXYKKDYXTCsqGamaruEhaxobcyvHxKEqjfuCczVQirHYgx"
	Max350TextLength    = 0
...
const (
	...
	ExternalPaymentCancellationRejection1CodeSample    = "Kw"
