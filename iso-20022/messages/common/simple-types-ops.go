...
const (
	...
	Max15NumericTextSample = "2268578353"
)
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "oJnNPGsiuzytMOJPatwtPilfsfykSBGplhxtxVSGpqaJaBRgAvzLX"
	Max105TextLength    = 0
...
const (
	...
	ExternalPaymentCancellationRejection1CodeSample    = "qz"
...
const (
	...
	ExternalClaimNonReceiptRejection1CodeSample    = "Rr"
...
const (
	...
	ExternalPaymentTransactionStatus1CodeSample    = "rU"
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "vaIujDpHYjxeUBrVfdwUzWHRihFDPRHBMuEWmaNvhHLITWJcJKzJsRPeJbpTqWPUlWAcid"
	Max140TextLength    = 0
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "ABK"
)
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "Rl"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "uf"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "mY"
...
const (
	...
	ExternalPaymentCompensationReason1CodeSample    = "Wd"
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "MH4YWXNT3RMK9R8EJ175"
)
...
const (
	...
	ExternalStatusReason1CodeSample    = "dE"
...
const (
	...
	ExternalDocumentType1CodeSample    = "kt"
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "BD"
...
const (
	...
	ExternalPaymentModificationRejection1CodeSample    = "rW"
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "ZT"
...
const (
	...
	ExternalMandateSetupReason1CodeSample    = "Pd"
...
const (
	...
	ExternalCancellationReason1CodeSample    = "mD"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "zzuuFjTKIOTjSnLTF"
	Max34TextLength    = 0
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "ioYayJwBotODVVVIrF"
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "Cq"
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "ZfARfsBVGBRaHjfFcQtXovQyXbjAyWbspgh"
	Max70TextLength    = 0
...
const (
	...
	ExternalInvestigationExecutionConfirmation1CodeSample    = "eq"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "XXu"
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "mwlaMkvqgeVNsLyylTpEsGuymNstQzxPbmXGYPZRoCcAjYwjicELciiQYDuPezahlBGYsXsQyazOWcrSbAuTepBSUGepQDYBzMBKXUbWscOLULiIiQtPiPomlXcvuojfHBHOQiGrmoSuelNipGLXawNpUCRNoVMTKOGgxNQPpRiWmNu"
	Max350TextLength    = 0
...
const (
	...
	ExternalPaymentGroupStatus1CodeSample    = "FO"
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "Pc"
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "tL"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "BlMZxcxWxtuKOMWJPK"
	Max35TextLength    = 0
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "LdPagMDpbVTfGYQeuDWBbAsCNeGzZKpmgINTkianyMbMixyxcPQjMCSHCDrkbuyV"
	Max128TextLength    = 0
...
const (
	...
	AnyBICDec2014IdentifierSample = "LYNHIGVPFD4"
)
...
const (
	...
	UUIDv4IdentifierSample = "58089272-da38-4ea6-accf-e2df30d09e61"
)
...
const (
	...
	Exact4AlphaNumericTextSample = "fZl6"
)
...
const (
	...
	IBAN2007IdentifierSample = "XC384IQevYr"
)
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "HY"
...
const (
	...
	BICFIDec2014IdentifierSample = "OOPOFH7062V"
)
...
const (
	...
	ExternalChargeType1CodeSample    = "pG"
