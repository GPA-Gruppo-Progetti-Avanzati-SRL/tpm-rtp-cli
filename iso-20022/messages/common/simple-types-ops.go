...
const (
	...
	ExternalStatusReason1CodeSample    = "oJ"
...
const (
	...
	ExternalPaymentModificationRejection1CodeSample    = "PG"
...
const (
	...
	ExternalDocumentFormat1CodeSample    = "si"
...
const (
	...
	ExternalChargeType1CodeSample    = "Pa"
...
const (
	...
	ExternalDocumentType1CodeSample    = "tw"
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "tP"
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "ilfsfykSBGplhxtxVSGpqaJaBRgAvzLXqzR"
	Max70TextLength    = 0
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "rrUIYvaIujDpHYjxe"
	Max34TextLength    = 0
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "UBr"
...
const (
	...
	BICFIDec2014IdentifierSample = "5HJ2FF0UPQL"
)
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "908FW2C4H2ZPPRTR5L13"
)
...
const (
	...
	ExternalPaymentCancellationRejection1CodeSample    = "Vf"
...
const (
	...
	AnyBICDec2014IdentifierSample = "UU16SQ0IQ39"
)
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "dw"
...
const (
	...
	ExternalPaymentCompensationReason1CodeSample    = "WH"
...
const (
	...
	ExternalClaimNonReceiptRejection1CodeSample    = "Ri"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "qWYIJMqLchMkCJZHSenoYIFnHZyTzEfMSdhUvtMBlfUoZYLEdqkoZCuTuRpLKzzuuFjTKIOTjSnLTFioYayJwBotODVVVIrFCqrhOGVehnNZfARfsBVGBRaHjfFcQtXovQyXbjAyWbspgheqXXumwlaMkvqgeVNsLyylTpEsGuymNst"
	Max350TextLength    = 0
...
const (
	...
	ExternalCashAccountType1CodeSample    = "xP"
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "bm"
...
const (
	...
	Exact4AlphaNumericTextSample = "wOQK"
)
...
const (
	...
	UUIDv4IdentifierSample = "dca54d55-ac68-4bfe-9011-ccaa6f54afbd"
)
...
const (
	...
	ExternalPaymentGroupStatus1CodeSample    = "XG"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "YP"
...
const (
	...
	ExternalInvestigationExecutionConfirmation1CodeSample    = "ZR"
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "oCcAjYwjicELciiQYDuPezahlBGYsXsQyazOWcrSbAuTepBSUGepQ"
	Max105TextLength    = 0
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "DY"
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "fM"
...
const (
	...
	ExternalPaymentTransactionStatus1CodeSample    = "Qx"
...
const (
	Max140TextZero      = ""
	Max140TextSample    = "iKGQfgjgNtyljntNWeqXXYMdxTRsqOTDdeltIIBZgZYJCjhEHHskeVLOdmPbocRvjeIFqc"
	Max140TextLength    = 0
...
const (
	...
	ExternalMandateSetupReason1CodeSample    = "bb"
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "yaToaaLLczPeHYSnzu"
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "NCZ"
)
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "lH"
...
const (
	...
	ExternalCancellationReason1CodeSample    = "Sa"
...
const (
	...
	IBAN2007IdentifierSample = "AB84XY1p"
)
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "xZ"
...
const (
	Max35TextZero      = ""
	Max35TextSample    = "VdHppAFbHZnhPpTOSy"
	Max35TextLength    = 0
...
const (
	Max128TextZero      = ""
	Max128TextSample    = "MuzRWOXcuCUExoZFaXYKKDYXTCsqGamaruEhaxobcyvHxKEqjfuCczVQirHYgxKw"
	Max128TextLength    = 0
