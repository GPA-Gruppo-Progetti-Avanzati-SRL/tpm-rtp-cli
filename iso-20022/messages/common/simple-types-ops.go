...
const (
	...
	BICFIDec2014IdentifierSample = "GA77TWKA"
)
...
const (
	Max34TextZero      = ""
	Max34TextSample    = "DAVCuvQutLDKFBGRx"
	Max34TextLength    = 0
...
const (
	...
	ExternalDiscountAmountType1CodeSample    = "ny"
...
const (
	...
	ExternalPersonIdentification1CodeSample    = "DN"
...
const (
	...
	ExternalClearingSystemIdentification1CodeSample    = "YuR"
...
const (
	...
	ExternalFinancialInstitutionIdentification1CodeSample    = "KW"
...
const (
	...
	ExternalInvestigationExecutionConfirmation1CodeSample    = "sm"
...
const (
	...
	ExternalCashClearingSystem1CodeSample    = "Zn"
...
const (
	...
	ExternalDocumentFormat1CodeSample    = "OY"
...
const (
	...
	ExternalPaymentCancellationRejection1CodeSample    = "gS"
...
const (
	...
	ExternalCashAccountType1CodeSample    = "LP"
...
const (
	...
	IBAN2007IdentifierSample = "QJ55aeJ"
)
...
const (
	...
	ExternalLocalInstrument1CodeSample    = "SsuMMmvYmaFEjLgSvn"
...
const (
	...
	ActiveOrHistoricCurrencyCodeSample = "POE"
)
...
const (
	Max350TextZero      = ""
	Max350TextSample    = "dTeranxGMNCcCdlEBYqxqrgAieJuFVZUsgPmweLRmsdTIwtLUDqoBSNtPRViLXLCrSAZCjxTCaZnfHRhEbbvlLkCbvOlRrOWJFNwNQBqyozKVGeninyrTgqubNiIzWcEZsdyUJTDAODnRKcTqZThaTJmRVAClOEaCEmEUmEtNTDVBbv"
	Max350TextLength    = 0
...
const (
	LEIIdentifierZero   = ""
	LEIIdentifierSample = "ZNOIZLSJ7D5KNZONH666"
)
...
const (
	...
	Exact4AlphaNumericTextSample = "MPkD"
)
...
const (
	...
	ExternalCategoryPurpose1CodeSample    = "Vy"
...
const (
	...
	ExternalCancellationReason1CodeSample    = "DF"
...
const (
	...
	ExternalOrganisationIdentification1CodeSample    = "fP"
...
const (
	Max2048TextZero      = ""
	Max2048TextSample    = ""
	Max2048TextLength    = 0
...
const (
	...
	ExternalClaimNonReceiptRejection1CodeSample    = "MT"
...
const (
	Max70TextZero      = ""
	Max70TextSample    = "KOGgxNQPpRiWmNuFOPctLBlMZxcxWxtuKOM"
	Max70TextLength    = 0
...
const (
	...
	AnyBICDec2014IdentifierSample = "K9EMNEP1LZU"
)
...
const (
	...
	ExternalDocumentLineType1CodeSample    = "WJ"
...
const (
	...
	ExternalDocumentType1CodeSample    = "PK"
...
const (
	...
	ExternalMandateSetupReason1CodeSample    = "Ld"
...
const (
	...
	ExternalTaxAmountType1CodeSample    = "Pa"
...
const (
	...
	ExternalAccountIdentification1CodeSample    = "fG"
...
const (
	Max1025TextZero      = ""
	Max1025TextSample    = ""
	Max1025TextLength    = 0
...
const (
	...
	UUIDv4IdentifierSample = "7259093f-f9bc-4217-ad8e-6293d6b816b2"
)
...
const (
	...
	ExternalPaymentTransactionStatus1CodeSample    = "OS"
...
const (
	Max105TextZero      = ""
	Max105TextSample    = "yMuzRWOXcuCUExoZFaXYKKDYXTCsqGamaruEhaxobcyvHxKEqjfuC"
	Max105TextLength    = 0
...
const (
	...
	ExternalGarnishmentType1CodeSample    = "cz"
...
const (
	...
	ExternalServiceLevel1CodeSample    = "VQ"
...
const (
	...
	ExternalPaymentModificationRejection1CodeSample    = "ir"
...
const (
	...
	ExternalChargeType1CodeSample    = "HY"
...
const (
	...
	ExternalProxyAccountType1CodeSample    = "gx"
...
const (
	...
	ExternalStatusReason1CodeSample    = "pG"
